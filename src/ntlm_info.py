...
class Type2Challenge:
    ...
    def decode(self):
        raw = self.raw
        if not raw:
            raise RuntimeError("No NTLM challenge received")
...
class Target:
    ...
    def _get_rdp_challenge(self):
        ...
        nla = (
            b"\x30\x37\xa0\x03\x02\x01\x60\xa1\x30\x30\x2e\x30\x2c\xa0\x2a\x04\x28"
            + REQ_FOR_CHALLENGE_BYTES
        )
